...
-- -----------------------------------------------------
-- Table `sistemaots`.`evento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistemaots`.`evento` (
  ...
  PRIMARY KEY (`idEvento`, `fecha_Evento`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `sistemaots`.`noticia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistemaots`.`noticia` (
